...
ISOLATE = ["kilo", "hena", "di", "tris", "tetra", "penta", "hexa", "hepta", "octa", "nona"] #not using ennea
...
def GreekGen(n):
    if (n > -1 and n < 21):
        ListOfAnnoyingExceptions = ["", "", "di", "tris", "tetra", "penta", "hexa", "hepta", "octa", "nona", "deka", "undeka", "dodeka", "trisdeka", "tetradeka", "pentadeka", "hexadeka", "heptadeka", "octadeka", "nonadeka", "icosa"]
