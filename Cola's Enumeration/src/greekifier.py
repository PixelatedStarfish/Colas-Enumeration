...
ISOLATE = ["kilo", "hena", "di", "tris", "tetra", "penta", "hexa", "hepta", "okta", "nona"] #not using ennea
CW_UNI = ['', 'un', 'do', 'tris', 'tetra', 'penta', 'hexa',
          'hepta', 'okta', 'nona']  
TEN =  ["", "deka", "icosi", "tricontakai", "tetracontakai", "pentacontakai", "hexacontakai", "heptacontakai", "oktacontakai", "nonacontakai"] # I use "deka" to distinguish from deci
HUN = ["", "hecta", "dihecta", "trihectakai", "tetrahectakai", "pentahectakai", "hexahectakai", "heptahectakai","oktahectakai", "nonahectakai"] # one hundred is technically hecto, but whatever...
PREC_TEN = ['', 'N', 'MS', 'NS', 'NS', 'NS', 'N', 'N', 'MX', '']
PREC_HUN = ['', 'NX', 'N', 'NS', 'NS', 'NS', 'N', 'N', 'MX', '']

METRIC = ['kilo', 'mega', 'giga', 'tera', 'peta', 'exa', 'zetta', 'yotta', 'ronna', 'quetta'] #this is the easter egg zone, add as many prefixes as you want
...
def GreekGen(n):
    if (n > -1 and n < 21):
        ListOfAnnoyingExceptions = ["", "", "di", "tris", "tetra", "penta", "hexa", "hepta", "okta", "nona", "deka", "undeka", "dodeka", "trisdeka", "tetradeka", "pentadeka", "hexadeka", "heptadeka", "oktadeka", "nonadeka", "icosa"]
